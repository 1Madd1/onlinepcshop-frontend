<template>
  <div class="row" style="text-align: center">
    <h4 class="col-12">NEW PRODUCTS</h4>
  </div>
  <div class="q-pa-md">
  ...
  <div v-else class="col text-center" style="height: 90vh; padding-top: 7%">
    ...
    <h2>There are no new products</h2>
...
export default {
  ...
  async created() {
    ...
    apiClient.request('get', `/multiple-tables/all-new-products`, null, null).then(
      result => {
        let tempResult = [];
  ...
  methods: {
    ...
    async search() {
      let url = '/multiple-tables/all-new-products?productName=' + this.searchText;
